<%@ Page Language="C#" MasterPageFile="~/DLTMasterPage.Master" AutoEventWireup="true" CodeBehind="DLTExceptionReports.aspx.cs" Inherits="ProjectEWSD.ExceptionReportsDLT" %>
    ...
    <form id="form1" runat="server">
        <div class="content-wrapper">
            ...
            <small>advanced tables</small>
                ...
                <ol class="breadcrumb">
                    <li><a href="DLTPage.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                    <li>Report</li>
