<%@ Page Title="" Language="C#" MasterPageFile="~/CLMasterPage.Master" AutoEventWireup="true" CodeBehind="CLHomePage.aspx.cs" Inherits="ProjectEWSD.WebForm3" %>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="timeline-footer">
                                                    ...
                                                    <br />
                                                    <asp:LinkButton CssClass="text-blue pull-left" CommandName="readmore" ID="readmore" runat="server" Text="Read more..." OnClick="readmore_Click" ></asp:LinkButton>
