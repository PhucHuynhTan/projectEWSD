<%@ Page Language="C#" MasterPageFile="~/DLTMasterPage.Master"  AutoEventWireup="true" CodeBehind="DLTDetailReports.aspx.cs" Inherits="ProjectEWSD.DetailStaticReportsDLT" %>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <b><asp:TextBox runat="server" ID="txtEmailTo" class="form-control"/></b>
                                    </div>
                                    <div class="form-group">
                                        <label>Comment :</label>  
